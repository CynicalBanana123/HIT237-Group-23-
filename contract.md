...
|---|---|
| Miguel Peachey | s384873 |
| Steele Martin | s332083 |
| Luke Hunter Stillwell Pols | s389968 |
| James Trung Minh Hee | s379658 |

## Selected Theme

The theme our group selected is theme 3 (remote housing crisis). The table below is an overview of the theme requirement and context.

| Requirements | Theme Context |
|---|---|
| Tenants in remote housing should be able to: <br> •Log housing repair requests <br> •Track status <br> •View house maintenance history| The northern territory has a high homelessness rate (12 times the national average and a large public housing waitlist. To deal with this, government programs aim to build more houses, including in remote areas. This app should aim to help alleviate the struggles of those who already live in remote housing and suffer from infrastructural issues.|

## Terms and Conditions of Group Work
